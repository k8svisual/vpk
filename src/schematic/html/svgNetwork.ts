...
export function svgNetwork(data: any, fnum: any) {
    let rectP1: string = '<rect  x="0" y="0" width="250" height="';
    let rectP2: string =
        '" rx="5" stroke-dasharray="1, 2" stroke-width="1"  stroke="black" fill="#a2d5fa"/>' + '<text x="205" y="12" class="pickIcon">Network</text>';
