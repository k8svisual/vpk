...
export function svgPVC(data, fnum) {
    let rectP1a = '<rect  x="0" y="0" width="';
    let rectP1b = '" height="';
    let rectP2 = '" rx="5" stroke-dasharray="1, 2" stroke-width="1"  stroke="black" fill="#fcdc79"/>' + '<text x="5" y="12" class="pickIcon">Storage</text>';
    let rectH = 0;
    let rectW = 0;
    let rtn = '';
